...
import { favorites, userPreferences, userBehavior, updateUserPreference, addFavorite, removeFavorite } from './state.js';
...
export function toggleLanguage() {
    try {
        ...
        updateUserPreference('language', newLang);
...
export function toggleHighContrast() {
    ...
    updateUserPreference('highContrast', newContrast);
...
export function toggleFavorite(locationKey) {
...
// ========================================
export function showInfo(location) {
    const info = locations[location];
    if (!info) {
        feedbackSystem.showError({
            message: userPreferences.language === 'th' ? 
...
export function initializeMap() {
    console.log("2. initializeMap called.");
    try {
        ...
        console.log("3. Data fetched from API.");
        locations = apiData.locations;
        locationCategories = apiData.locationCategories;
...
export function initializeEnhancedStartup() {
    console.log("4. initializeEnhancedStartup called.");
...
export function quickStartCultural() {
    startExploring();
    setTimeout(() => {
...
export function quickStartNature() {
    startExploring();
    setTimeout(() => {
...
export function quickStartBeach() {
    startExploring();
    setTimeout(() => {
